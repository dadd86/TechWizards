...
public final class IMatchEventDao_Impl implements IMatchEventDao {
  ...
  private final EntityInsertionAdapter<MatchEventEntity> __insertionAdapterOfMatchEventEntity_1;
  ...
  public IMatchEventDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMatchEventEntity = new EntityInsertionAdapter<MatchEventEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `MatchEvent` (`id`,`matchId`,`seq`,`type`,`actorNum`,`payloadJson`,`createdAtMs`) VALUES (?,?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfMatchEventEntity_1 = new EntityInsertionAdapter<MatchEventEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
  ...
  public Object insertar(final MatchEventEntity evento,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfMatchEventEntity_1.insert(evento);
          __db.setTransactionSuccessful();
