...
fun PantallaEventos(
    ...
    val eventos = listOf(
        Triple(
            stringResource(id = R.string.events_daily_challenge),
            0.6f,
            stringResource(id = R.string.events_progress_label)
        ),
        Triple(
            stringResource(id = R.string.events_weekend_tournament),
            0.3f,
            stringResource(id = R.string.events_progress_label)
        ),
        Triple(
            stringResource(id = R.string.events_special_drop),
            0.9f,
            stringResource(id = R.string.events_progress_label)
        )
    )
